...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-dark shadow-sm" style="background-color: #2F2E40;">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
				    ...
				    <a class="dropdown-item" href="{{ route('user', [Auth::id()]) }}">My Profile</a>
        ...
        <footer class="mt-4 mb-4 text-center">
            <a href="https://antrum-technologies.nl?utm_source=racketplanner"><img src="/antrum-banner.png" style="width: 100%; max-width: 400px; margin-bottom: -25px"></a>
        </footer>
    </div>
</body>
</html>
