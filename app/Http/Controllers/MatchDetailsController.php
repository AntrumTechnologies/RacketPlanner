...
class MatchDetailsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'player1' => 'required|exists:users',
            'player2' => 'required|exists:users|different:player1',
            'player3' => 'sometimes|required|exists:users|different:player2',
            'player4' => 'sometimes|required|exists:users|different:player3',
            'court' => 'required|exists:courts',
            'datetime' => 'required|date_format:yyyy-mm-dd H:i',
		]);
