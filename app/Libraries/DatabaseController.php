...
class DatabaseController extends Controller
{
    ...
    public function GetRoundById($id) {
        ...
        return Round::where('id', $id)->where('tournament_id', $this->tournamentId)->first()->toArray(); // Do not allow getting courts from other tournaments
    }
    ...
    public function GetPlayers() {
        ...
        return Player::select('players.*', 'users.rating')
            ->where('players.tournament_id', $this->tournamentId)
    ...
    public function DeletePlayerByUserId($userId) {
        ...
        $player = Player::where('user_id', $userId)->where('tournament_id', $this->tournamentId);
    ...
    public function GetMatches() {
        ...
        return MatchDetails::where('tournament_id', $this->tournamentId)->get();
    }

    public function GetMatchById($matchId) {
        Report::Trace(__METHOD__);

        return MatchDetails::where('id', $matchId)->where('tournament_id', $this->tournamentId)->first()->toArray();
    }
    ...
    public function EnableAllMatches() {
        ...
        MatchDetails::where('tournament_id', $this->tournamentId)->update(['disabled' => 0]);
    }
    ...
    public function GetSchedule() {
        ...
        return Schedule::where('tournament_id', $this->tournamentId)->get();
    }

    public function DeleteSchedule() {
        Report::Trace(__METHOD__);

        $schedule = Schedule::where('tournament_id', $this->tournamentId)->get();
        $schedule->delete();
    }
    ...
    public function SetSlotStateToClinic($slotId) {
        Report::Trace(__METHOD__);
        Report::Debug($slotId);
        Report::Debug($this->tournamentId);
    ...
    public function GetMatchesForRound($roundId) {
        ...
        return MatchDetails::select('matches.*')
            ...
            ->where('schedules.round_id', $roundId)
            ->get();
    }
