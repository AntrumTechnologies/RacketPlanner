...
class PlayersTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Player::create(['user_id' => 4, 'tournament_id' => 2, 'clinic' => 1]);
        Player::create(['user_id' => 5, 'tournament_id' => 1]);
        Player::create(['user_id' => 6, 'tournament_id' => 2, 'clinic' => 1]);
        ...
        Player::create(['user_id' => 12, 'tournament_id' => 2, 'clinic' => 1]);
        Player::create(['user_id' => 13, 'tournament_id' => 2, 'clinic' => 1]);
        ...
        Player::create(['user_id' => 18, 'tournament_id' => 2, 'clinic' => 1]);
        Player::create(['user_id' => 19, 'tournament_id' => 2, 'clinic' => 1]);
        Player::create(['user_id' => 20, 'tournament_id' => 2]);
        Player::create(['user_id' => 21, 'tournament_id' => 1]);
        Player::create(['user_id' => 22, 'tournament_id' => 2]);
        Player::create(['user_id' => 23, 'tournament_id' => 1, 'clinic' => 1]);
        Player::create(['user_id' => 24, 'tournament_id' => 2, 'clinic' => 1]);
        Player::create(['user_id' => 25, 'tournament_id' => 1, 'clinic' => 1]);
        Player::create(['user_id' => 26, 'tournament_id' => 2, 'clinic' => 1]);
        Player::create(['user_id' => 27, 'tournament_id' => 2, 'clinic' => 1]);
        Player::create(['user_id' => 28, 'tournament_id' => 2]);
        Player::create(['user_id' => 29, 'tournament_id' => 1, 'clinic' => 1]);
        Player::create(['user_id' => 30, 'tournament_id' => 2]);
        Player::create(['user_id' => 31, 'tournament_id' => 1]);
        Player::create(['user_id' => 32, 'tournament_id' => 1, 'clinic' => 1]);
        ...
        Player::create(['user_id' => 38, 'tournament_id' => 1, 'clinic' => 1]);
        Player::create(['user_id' => 39, 'tournament_id' => 2, 'clinic' => 1]);
        ...
        Player::create(['user_id' => 46, 'tournament_id' => 1, 'clinic' => 1]);
        Player::create(['user_id' => 47, 'tournament_id' => 1, 'clinic' => 1]);
        Player::create(['user_id' => 48, 'tournament_id' => 1, 'clinic' => 1]);
        Player::create(['user_id' => 49, 'tournament_id' => 1]);
        Player::create(['user_id' => 50, 'tournament_id' => 1]);
        Player::create(['user_id' => 51, 'tournament_id' => 1]);
        Player::create(['user_id' => 52, 'tournament_id' => 1, 'clinic' => 1]);
        Player::create(['user_id' => 53, 'tournament_id' => 1]);
        Player::create(['user_id' => 54, 'tournament_id' => 1]);
        Player::create(['user_id' => 55, 'tournament_id' => 1, 'clinic' => 1]);
        Player::create(['user_id' => 56, 'tournament_id' => 1]);
        Player::create(['user_id' => 57, 'tournament_id' => 1, 'clinic' => 1]);
        Player::create(['user_id' => 58, 'tournament_id' => 1, 'clinic' => 1]);
        Player::create(['user_id' => 59, 'tournament_id' => 1, 'clinic' => 1]);
        ...
        Player::create(['user_id' => 65, 'tournament_id' => 1, 'clinic' => 1]);
